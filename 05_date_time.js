...
// const end = new Date("2023-09-18T00:00:00Z");

// console.log(today);
// console.log(end);
// setInterval(() => {
//     leftTime = end - today;
//     console.log(Math.ceil(leftTime / (1000*60*60)))
//     console.log(Math.ceil(leftTime / (1000*60)))
//     console.log(Math.ceil(leftTime / 1000))
//     console.log("====")
// }, 1000)
